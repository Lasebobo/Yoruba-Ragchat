  ...
  return (
    <article className="mx-auto flex w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-card)]">
      ...
      <div className="flex flex-col p-5 gap-5">
        {/* History Block */}
        <section className="rounded-xl border border-[#FFF9C4]/50 bg-[#FFF9C4]/30 p-4">
          <h2 className="mb-2 flex items-center gap-2 font-semibold text-[#8A4F1D]">
        ...
        <section className="rounded-xl border border-[#E0F2F1]/50 bg-[#E0F2F1]/40 p-4">
          <h2 className="mb-2 flex items-center gap-2 font-semibold text-[#00695C]">
        ...
        {ingredients.length > 0 ? (
          <section
            ...
            className="rounded-xl border border-[#ECEFF1]/80 bg-[#ECEFF1]/40 p-4"
          >
            <h2 className="mb-3 flex items-center gap-2 font-semibold text-[#455A64]">
            ...
            >
              {ingredients.map((ingredient, index) => {
                ...
                return (
                  <div
                    className="flex w-36 shrink-0 snap-start flex-col gap-2 rounded-lg border border-border/60 bg-white/60 p-2 shadow-sm"
                  ...
                  >
                    {imageUrl ? (
                      ...
                      <div className="h-24 w-full rounded-md bg-muted/50 flex items-center justify-center text-muted-foreground/30">
