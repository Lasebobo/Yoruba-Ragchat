import { ar as Ue } from "./pane2-DFEdyvZy.js";
function Ge(G, K) {
          ...
          pe.prototype.decode = function (e) {
            function r(d, u, i) {
              ...
              if (i === 2)
                return (
                  (d >= 2048 >> u && d << u <= 55_295) ||
                  (d >= 57_344 >> u && d << u <= 65_535)
                );
              if (i === 3) return d >= 65_536 >> u && d << u <= 1_114_111;
              throw new Error();
            }
            function n(d, u) {
                ...
                a === 0 &&
                  (s <= 65_535
                    ...
                    : ((o += String.fromCharCode(
                        55_296 + ((s - 65_535 - 1) >> 10)
                      )),
                      (o += String.fromCharCode(
                        56_320 + ((s - 65_535 - 1) & 1023)
                      ))));
            }
...
`),
          ...
          Ee.prototype.open = (e, r, n, t, o, a, s) => {
            ...
            (e.onprogress = () => {
              ...
              (e.withCredentials = a);
            for (var f in s) Object.hasOwn(s, f) && e.setRequestHeader(f, s[f]);
            return e.send(), e;
          };
          function we(e) {
            this._headers = e;
          ...
          function qe(e, r, n) {
            ...
            var t = !!n.withCredentials,
              ...
              i = n.headers || {},
              l = n.Transport,
              D = Pe && l == null ? void 0 : new j(l == null ? Me() : new l()),
              z =
...
`),
              ...
              Q = () => {
                ...
                var g = e.headers;
                if (g != null)
                  for (var O in g) Object.hasOwn(g, O) && (m[O] = g[O]);
                try {
