import { d as e } from "./pane2-DFEdyvZy.js";
const n = e("structure", {
  ...
  "incoming-references-input.list-label":
    "Incoming references of type {{type}}",
  "incoming-references-input.no-items": "No items",
  "incoming-references-input.reference-from": "Reference from {{type}}",
  "incoming-references-input.schema-type-not-found":
  ...
  "incoming-references-input.types-loading-cross-dataset":
    "Loading cross dataset documents...",
  ...
  "incoming-references-pane.no-references-found":
    "No references of this type found.",
  "incoming-references-pane.schema-type-not-found":
    "Schema type {{type}} not found",
